        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{asset('image/msekko.png')}}" width="75" height="30" alt="Msekko Logo" >
                </a>
            </div>
                        ...
                        @if ((Auth::user()->token_id)>=5)
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ url('/admin') }}"><i class="fa fa-btn fa-sign-out"></i>用户管理</a></li>
                                    <li><a href="{{ url('/addr') }}"><i class="fa fa-btn fa-sign-out"></i>地址管理</a></li>
                                </ul>
                            </li>
                        @endif
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/user') }}"><i class="fa fa-btn fa-sign-out"></i>密码修改</a></li>
